...
The difference between 2 and 1 is 12.67 seconds however after 3 threads there are not any significant difference as the time stays within the range of 16 to 17 seconds. Therefore, the largest acceleration factor is 1.79.
